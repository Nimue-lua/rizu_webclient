  ...
  return (
    <header className="song-select-header">
      ...
      <nav className="header-actions" aria-label="Account and settings">
        {onGlobalLeaderboard && <button className="global-leaderboard-button" onClick={onGlobalLeaderboard}><SongSelectIcon name="trophy" />Rankings</button>}
        ...
        <div className="header-icon-dock">
          ...
          {onOpenLibrarySources && <button aria-label="Library sources" title="Library sources" onClick={onOpenLibrarySources}><SongSelectIcon name="folder" /></button>}
          {onRefreshLibrary && <button className={library_scanning ? "scanning" : ""} aria-label="Refresh library" title={library_scanning ? "Refresh library (scan in progress)" : "Refresh library"} onClick={onRefreshLibrary}><SongSelectIcon name="refresh" /></button>}
