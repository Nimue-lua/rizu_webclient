...
import { isAccuracySource, isComboSource, isJudgesSource, isScoreSource,
  type IAccuracySource, type IComboSource, type IJudgesSource, type IScoreSource } from "./ScoreSources";
