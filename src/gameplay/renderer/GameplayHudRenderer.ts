...
export class SpriteGameplayHudRenderer implements GameplayHudRenderer {
  ...
  private drawHpBar(): void {
    ...
    if (background) this.write(0, 0, background.sourceSize.w * OSU_NATIVE_SCALE * 0.96,
      background.sourceSize.h * OSU_NATIVE_SCALE * 0.96,
      [1, 1, 1, 1], background);
    if (fill) this.write(7.5, 7.8, fill.sourceSize.w * OSU_NATIVE_SCALE * 0.965,
      fill.sourceSize.h * OSU_NATIVE_SCALE * 0.965,
      [1, 1, 1, 1], fill);
  }
